 ...
 * @author Seraght
 */
public class ReviewUp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean result = p.review(review, status, ticketID);

        if (result != false) {
            
            message = "ขอบพระคุณที่ให้ความร่วมมือ";
        } else {
            message = "โปรดลองใหม่อีกครั้ง";
        }
        target = "/front/review_ticket_result.jsp";
